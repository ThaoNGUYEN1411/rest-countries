...
public class Country {
    ...
    private String coatOfArmUrl;

    @Column(name = "google_maps_url")
    private String googleMapsUrl;

    public Country() {
	// required by ORM Object relational Mapping
    }
    ...
    public String getCoatOfArmUrl() {
	return coatOfArmUrl;
    }

    public void setCoatOfArmUrl(String coatOfArmUrl) {
	this.coatOfArmUrl = coatOfArmUrl;
    }
	...
	return "{id=" + id + ", isoCode=" + isoCode + ", countryName=" + countryName + ", countryPopulation="
		...
		+ ", flagUrl=" + flagUrl + ", coatOfArmUrl=" + coatOfArmUrl + ", googleMapsUrl=" + googleMapsUrl + "}";
    }
